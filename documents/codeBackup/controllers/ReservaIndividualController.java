...
public class ReservaIndividualController {
    ...
    public ResponseEntity<ReservaIndividual> insert(@RequestBody ReservaIndividual obj) {
        obj = service.insert(obj);
        return ResponseEntity.ok().body(obj);
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT)
    public ResponseEntity<ReservaIndividual> update(@RequestBody ReservaIndividual obj) {
