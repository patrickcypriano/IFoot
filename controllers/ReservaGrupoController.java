...
// @RequestMapping(method = RequestMethod.POST)
// public ResponseEntity<ReservaGrupo> insert(@Valid @RequestBody ReservaGrupo
// obj, BindingResult br) {
// if (br.hasErrors())
// throw new ConstraintException(br.getAllErrors().get(0).getDefaultMessage());
// obj = service.insert(obj);
// return ResponseEntity.ok().body(obj);
...
// public ResponseEntity<ReservaGrupo> update(@Valid @RequestBody ReservaGrupo
// obj, BindingResult br) {
// if (br.hasErrors())
// throw new ConstraintException(br.getAllErrors().get(0).getDefaultMessage());
// obj = service.update(obj);
...
// @RequestMapping(value = "/{campoId}/{horarioId}", method =
