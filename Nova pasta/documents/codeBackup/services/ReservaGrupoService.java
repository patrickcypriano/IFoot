...
public class ReservaGrupoService {
    ...
    public ReservaGrupo insert(ReservaGrupo obj) {
        try {
            ...
            throw new DataIntegrityException(
                    "Campo(s) obrigatório(s) da ReservaGrupo não foi(foram) preenchido(s): CampoHorario (Campo e/ou Horario)");
        }
    }
    ...
    public void delete(Integer idCampo, Integer idHorario) {
        ...
        try {
            ...
            throw new DataIntegrityException("Não é possível excluir esta Reserva em Grupo");
        }
    }
}